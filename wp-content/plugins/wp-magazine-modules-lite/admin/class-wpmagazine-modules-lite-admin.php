...
if( !class_exists( 'Wpmagazine_modules_Lite_Admin' ) ) :
    class Wpmagazine_modules_Lite_Admin {
        ...
        public function admin_enqueue_scripts( $hook_suffix ) {
            wp_enqueue_style( 'wpmagazine-modules-lite-admin-notice-style',
            ...
            wp_enqueue_style( 'wpmagazine-modules-lite-admin-style',
                plugins_url( 'css/admin.css', __FILE__ ),
                array(),
                WPMAGAZINE_MODULES_LITE_VERSION,
                'all'
            );
            wp_enqueue_style( 'wpmagazine-modules-lite-icons-style',
                esc_url( WPMAGAZINE_MODULES_LITE_INCLUDES_URL . '/assets/cvmm-icons/style.css' ),
                array(),
                WPMAGAZINE_MODULES_LITE_VERSION,
                'all'
            );

            wp_enqueue_script( 'wpmagazine-modules-lite-admin-script',
        ...
        ?>
            <div id="cvmm-plugin-admin-notice" class="notice updated is-dismissible">
                ...
                <div class="links">
                    <a href="<?php echo esc_url( '//wordpress.org/support/plugin/wp-magazine-modules-lite/reviews/#new-post' ); ?>" class="btn button-primary" target="_blank">
                    ...
                    <a href="<?php echo esc_url( '//wordpress.org/support/plugin/wp-magazine-modules-lite/' ); ?>" class="btn button-secondary" target="_blank">
        ...
        public function upgrade_admin_notice() {
            ...
            ?>
                <div id="cvmm-plugin-admin-notice" class="notice updated is-dismissible">
                    ...
                    <div class="links">
                        <a href="<?php echo esc_url( 'https://codevibrant.com/wp-plugin/wp-magazine-modules-for-gutenberg-elementor/' ); ?>" class="btn button-primary" target="_blank">
